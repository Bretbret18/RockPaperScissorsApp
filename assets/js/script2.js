...
console.log(playerResult.childNodes);
...
function shootEvent() {
    shootBtn.addEventListener('click', function (e) {
        ...
        setTimeout(() => {
            ...
            console.log(playerResult.childNodes[0].className);
            if(playerResult.childNodes[0].className === 'bi bi-gem') {
                console.log('rock');
            }
            ...
            function handleLocalStorage() {
                ...
                let loseResult = roundResults[1].opponentWin;
                let drawResult = roundResults[2].draw;
                if(winResult == true || loseResult == true || drawResult == true) {
                    console.log(winResult, loseResult, drawResult);
                    localStorage.setItem('Win/Lose/Draw', `[${winResult}/${loseResult}/${drawResult}]`)
                }
